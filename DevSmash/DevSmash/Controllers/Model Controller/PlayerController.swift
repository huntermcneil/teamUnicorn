...
class PlayerController {
    ...
    //MARK: - SOT
    var players: [Player] = [Player(name: "Stacy", health: "73%", stamina: "62%", bio: "Martinez is not her maiden name", fightingFrom: "Pleasant View, UT"), Player(name: "Jill", health: "77%", stamina: "50%", bio: "Has many spiders", fightingFrom: "Highland, UT"), Player(name: "Lindsey", health: "90%", stamina: "90% with coffee", bio: "Wants a puppy", fightingFrom: "Pittsburgh, PA"), Player(name: "Mathias", health: "100%", stamina: "20%", bio: "Real name is David", fightingFrom: "Layton, UT"), Player(name: "Hunter", health: "7%", stamina: "2%", bio: "Gets married in 11 days", fightingFrom: "Mesa, AZ")]
